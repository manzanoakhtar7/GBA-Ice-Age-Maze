...
OFILES = gba.o font.o logic.o graphics.o main.o images/acorn.o images/ice.o images/instructions.o images/loser.o images/squirrel.o images/title.o images/winner.o
